...
export const routes: Routes = [
  ...
  { path: 'import-students', canActivate: [authGuard], loadComponent: () => import('./features/import-students/import-students').then(c => c.ImportStudents) },
  { path: 'user-management', canActivate: [authGuard], loadComponent: () => import('./features/user-management/user-management').then(c => c.UserManagement) },
  { path: 'add-teacher', canActivate: [authGuard], loadComponent: () => import('./features/add-teacher/add-teacher').then(c => c.AddTeacher) },
  { path: 'transfer-student', canActivate: [authGuard], loadComponent: () => import('./features/transfer-student/transfer-student').then(c => c.TransferStudent) },
