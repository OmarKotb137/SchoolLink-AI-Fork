...
────────────────────────────────────
● حفظ أسئلة الامتحان في بنك الأسئلة + إنشاء البحث الدلالي (embedding) للطلاب
● Arguments: examUid (string — UID الامتحان من رابط المعاينة), subjectId (int — معرف المادة)
● الاستخدام: بعد توليد امتحان، إذا قال المدرس ""حفظ في البحث الدلالي"" أو ""تمكين البحث للطلاب""
● الأداة تقوم بكل شيء آلياً: حفظ في بنك الأسئلة + تضمين في قاعدة المتجهات للبحث الدلالي
...
● عاوز يضيف أسئلة امتحان للبنك + تمكين البحث الدلالي للطلاب → استخدم save_to_question_embeddings
  - مطلوب examUid (من رابط المعاينة) و subjectId
  - الأداة تحفظ في بنك الأسئلة وتنشئ embedding للبحث الدلالي
