...
● Arguments الاختيارية:
   - subjectId (int): معرف المادة (من get_subjects). لو محططش، هتحتاج تحط classSubjectTeacherId.
   - classSubjectTeacherId (int): بديل عن subjectId (اختياري).
...
● ملاحظة: إذا لم يحدد المدرس فصلاً معيناً، فقط استخدم subjectId والأداة هتختار أول فصل متاح تلقائياً.
...
أ. المدرس عاوز امتحان لمادة معينة:
   ...
   6. استخدم generate_exam_with_ai(title=..., subjectId=..., ...) — subjectId كافي، الأداة هتresolve أول فصل متاح تلقائياً.
