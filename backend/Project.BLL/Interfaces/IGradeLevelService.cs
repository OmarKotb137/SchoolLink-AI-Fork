...
public interface IGradeLevelService
{
    ...
    Task<OperationResult<GradeLevelDto>>              CreateGradeLevelValidatedAsync(CreateGradeLevelRequest request);
    Task<OperationResult<GradeLevelDto>>              UpdateGradeLevelAsync(UpdateGradeLevelRequest request);
    Task<OperationResult<GradeLevelDto>>              UpdateGradeLevelValidatedAsync(UpdateGradeLevelRequest request);
